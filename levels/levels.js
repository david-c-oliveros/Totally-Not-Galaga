const DemoLevels = [[{type: 1, num:  0, rows: 1},
                     {type: 3, num:  5, rows: 1},
                     {type: 4, num: 10, rows: 2}],

                    [{type: 1, num:  4, rows: 1},
                     {type: 3, num: 10, rows: 2},
                     {type: 4, num: 12, rows: 2}],
                   ];
...
const LevelSet_1= [
                   ...
                   [{type: 1, num:  4, rows: 1},
                    {type: 3, num: 16, rows: 2},
                    {type: 4, num: 20, rows: 2}],

                   [{type: 1, num:  4, rows: 1},
                    {type: 3, num: 18, rows: 2},
                    {type: 4, num: 22, rows: 2}],
                   ...
                   [{type: 1, num: 16, rows: 2},
                    {type: 4, num: 38, rows: 4},
                    {type: 3, num: 36, rows: 3}],

                   [{type: 1, num: 20, rows: 2},
                    {type: 4, num: 39, rows: 3},
                    {type: 3, num: 42, rows: 3}],
